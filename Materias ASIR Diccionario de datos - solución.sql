drop database if exists MateriasASIR;
...
#-----------------------------------------------------------------------------------------------------------------
#	CREAMOS ENLAES ENTRE LAS TABLAS
#-----------------------------------------------------------------------------------------------------------------
alter table materia
	add constraint materia_sigla foreign key (siglas) references sigla(siglas);
...
insert into Materia (ID, Siglas, Codigo, Horas) values ( 13,   'FCT', 'MPxxxx', 384 );
insert into Materia (ID, Siglas, Codigo, Horas) values ( 14,   'PROX', 'MPyyyy', 26 );
