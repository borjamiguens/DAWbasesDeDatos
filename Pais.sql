...
alter table Provincias 	modify Nombre 		varchar (25) 	not null,
						modify id_capital	int 			not null,
						modify id_comunidad int 			not null;
    
alter table Comunidades modify Nombre 		varchar (25) 	not null,
						modify id_capital 	int 			not null;
...
select * from Localidades natural join Provincias natural join Comunidades;